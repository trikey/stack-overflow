...
feature 'Search', %q(
  ...
  given!(:search_comment_01) { create(:comment, body: 'Comment 01 with search body', user: user) }
  given!(:search_comment_02) { create(:comment, body: 'Comment 02 with search body', user: user) }
  ...
  given!(:not_search_comment) { create(:comment, body: 'Comment with body', user: user) }
